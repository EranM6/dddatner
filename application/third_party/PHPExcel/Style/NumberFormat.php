...
class PHPExcel_Style_NumberFormat extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
    ...
    /**
     * ExcelFile built-in number formats
     *
     * @var array
     */
    ...
    /**
     * ExcelFile built-in number formats (flipped, for faster lookups)
     *
     * @var array
     */
    ...
    private static function fillBuiltInFormatCodes()
    {
        ...
        //  ExcelFile defines built-in format IDs
        //      14: "m/d/yyyy"
        //      22: "m/d/yyyy h:mm"
        //      37: "#,##0_);(#,##0)"
        //      38: "#,##0_);[Red](#,##0)"
    ...
    /**
     * Search/replace values to convert ExcelFile date/time format masks to PHP format masks
     *
     * @var array
     */
    ...
    /**
     * Search/replace values to convert ExcelFile date/time format masks hours to PHP format masks (24 hr clock)
     *
     * @var array
     */
    ...
    /**
     * Search/replace values to convert ExcelFile date/time format masks hours to PHP format masks (12 hr clock)
     *
     * @var array
     */
    ...
    public static function toFormattedString($value = '0', $format = PHPExcel_Style_NumberFormat::FORMAT_GENERAL, $callBack = null)
    {
        ...
        // For 'General' format code, we just pass the value although this is not entirely the way ExcelFile does it,
        ...
        // Here is how the sections apply to various values in ExcelFile:
        ...
        // In ExcelFile formats, "_" is used to add spacing,
