    ...
    public static function createReaderForFile($pFilename)
    {
        ...
        if (isset($pathinfo['extension'])) {
            switch (strtolower($pathinfo['extension'])) {
                case 'xlsx':            //    ExcelFile (OfficeOpenXML) Spreadsheet
                case 'xlsm':            //    ExcelFile (OfficeOpenXML) Macro Spreadsheet (macros will be discarded)
                case 'xltx':            //    ExcelFile (OfficeOpenXML) Template
                case 'xltm':            //    ExcelFile (OfficeOpenXML) Macro Template (macros will be discarded)
                    $extensionType = 'Excel2007';
                    break;
                case 'xls':                //    ExcelFile (BIFF) Spreadsheet
                case 'xlt':                //    ExcelFile (BIFF) Template
                ...
                case 'slk':
                    $extensionType = 'SYLK';
                    break;
                case 'xml':                //    ExcelFile 2003 SpreadSheetML
                ...
                case 'csv':
                    ...
                    // all files including ExcelFile files etc.
                    break;
                default:
                    break;
            }
