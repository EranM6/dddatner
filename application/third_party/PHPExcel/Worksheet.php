...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
    ...
    /**
     * Check sheet code name for valid ExcelFile syntax
     *
   ...
   /**
     * Check sheet title for valid ExcelFile syntax
     *
     * @param string $pValue The string to check
     * @return string The valid string
...
/**
     ...
     *
     * @param null|string Same rule as Title minus space not allowed (but, like ExcelFile, change silently space to underscore)
     * @return objWorksheet
     * @throws PHPExcel_Exception
    */
    public function setCodeName($pValue = null)
    {
        ...
        $pValue = str_replace(' ', '_', $pValue);//ExcelFile does this automatically without flinching, we are doing the same
        // Syntax check
        // throw an exception if not valid
        self::checkSheetCodeName($pValue);

        // We use the same code that setTitle to find a valid codeName else not using a space (ExcelFile don't like) but a '_'
