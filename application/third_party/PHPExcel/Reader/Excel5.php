...
//     Modelled moreso after Perl ExcelFile Parse/Write modules
...
//     Included a testcase ExcelFile file and PHP example calls
...
class PHPExcel_Reader_Excel5 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    /**
     * Codepage set in the ExcelFile file being read. Only important for BIFF5 (ExcelFile 5.0 - ExcelFile 95)
     * For BIFF8 (ExcelFile 97 - ExcelFile 2003) this will always have the value 'UTF-16LE'
     *
     * @var string
     */
    private $codepage;
    ...
    public function listWorksheetNames($pFilename)
    {
        ...
        // total byte size of ExcelFile data (workbook global substream + sheet substreams)
...
//        $recordData = $this->readRecordData($this->data, $this->pos + 4, $length);
    ...
    /**
     *    The NOTE record specifies a comment associated with a particular cell. In ExcelFile 95 (BIFF7) and earlier versions,
     *        this record stores a note (cell note). This feature was significantly enhanced in ExcelFile 97.
     */
...
//        echo '<br />';
        ...
        switch ($substreamType) {
            case self::XLS_WorkbookGlobals:
                ...
                if (($version != self::XLS_BIFF8) && ($version != self::XLS_BIFF7)) {
                    throw new PHPExcel_Reader_Exception('Cannot read this ExcelFile file. Version is too old.');
                }
     ...
     * and 1 cell XF.
     * Inspection of ExcelFile files generated by MS Office ExcelFile shows that XF records 0-14 are cell style XF
    ...
    private function readSheetPr()
    {
        ...
        // this corresponds to radio button setting in page setup dialog in ExcelFile
     ...
     * ExcelFile still uses this record, if it copies unformatted
...
//        echo '<br />';
    ...
    private function readSheetLayout()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            // ExcelFile 2003 uses size of 0x14 (documented), ExcelFile 2007 uses size of 0x28 (not documented?)
            ...
            switch ($sz) {
                case 0x14:
                    ...
                    break;
                case 0x28:
                    // TODO: Investigate structure for .xls SHEETLAYOUT record as saved by MS Office ExcelFile 2007
                    return;
                    break;
            }
        }
     ...
     * Reading of this record is based on Microsoft Office ExcelFile 97-2000 Binary File Format Specification,
    ...
    /**
     * Convert formula structure into human readable ExcelFile formula like 'A3+A5*5'
     *
    ...
    private function createFormulaFromTokens($tokens, $additionalData)
    {
        ...
        foreach ($tokens as $token) {
            ...
            switch ($token['name']) {
                ...
                case 'tAttrSkip':
                case 'tAttrChoose':
                    // token is only important for ExcelFile formula evaluator
                    // do nothing
                    break;
    ...
    /**
     * Extract RGB color
     * OpenOffice.org's Documentation of the Microsoft ExcelFile File Format, section 2.5.4
     *
    ...
    /**
     * Extracts an ExcelFile Unicode short string (8-bit string length)
    ...
    /**
     * Extracts an ExcelFile Unicode long string (16-bit string length)
     * OpenOffice documentation: 2.5.3
     ...
     * this function is under construction, needs to support rich text, and Asian phonetic settings
     * OpenOffice.org's Documentation of the Microsoft ExcelFile File Format, section 2.5.3
     *
     * @param string $subData
