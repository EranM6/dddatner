...
class PHPExcel_Worksheet_SheetView
{
    ...
    {
        // Microsoft Office ExcelFile 2007 only allows setting a scale between 10 and 400 via the user interface,
    ...
    {
        // MS ExcelFile 2007 allows setting the view to 'normal', 'pageLayout' or 'pageBreakPreview' via the user interface
        if ($pValue === null) {
