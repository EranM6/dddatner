...
class PHPExcel_Worksheet_AutoFilter
{
    ...
    /**
     *    Test if cell value is in the defined set of ExcelFile date values
     *
     *    @param    mixed        $cellValue
     *    @param    mixed[]        $dataSet
     *    @return boolean
    ...
    /**
     *    Search/Replace arrays to convert ExcelFile wildcard syntax to a regexp syntax for preg_matching
     *
     *    @var    array
     */
