...
class PHPExcel_Shared_Font
{
     ...
     * Empirical data found by inspecting real ExcelFile files and reading off the pixel width
     * in Microsoft Office ExcelFile 2007.
     *
     * @var array
     */
    ...
    public static function calculateColumnWidth(PHPExcel_Style_Font $font, $cellText = '', $rotation = 0, PHPExcel_Style_Font $defaultFont = null)
    {
        ...
        if (!$approximate) {
            ...
            try {
                ...
                // and addition because ExcelFile adds some padding, just use approx width of 'n' glyph
...
//        $upperLeftCornerY  = $textBox[7];
    ...
    public static function getTextWidthPixelsApprox($columnText, PHPExcel_Style_Font $font = null, $rotation = 0)
    {
        ...
        switch ($fontName) {
            case 'Calibri':
                // value 8.26 was found via interpolation by inspecting real ExcelFile files with Calibri 11 font.
                $columnWidth = (int) (8.26 * PHPExcel_Shared_String::CountCharacters($columnText));
                $columnWidth = $columnWidth * $fontSize / 11; // extrapolate from font size
                break;

            case 'Arial':
                // value 7 was found via interpolation by inspecting real ExcelFile files with Arial 10 font.
//                $columnWidth = (int) (7 * PHPExcel_Shared_String::CountCharacters($columnText));
            ...
            case 'Verdana':
                // value 8 was found via interpolation by inspecting real ExcelFile files with Verdana 10 font.
                $columnWidth = (int) (8 * PHPExcel_Shared_String::CountCharacters($columnText));
                $columnWidth = $columnWidth * $fontSize / 10; // extrapolate from font size
                break;
    ...
    {
        switch ($name) {
            // Add more cases. Check FONT records in real ExcelFile files.
            case 'EucrosiaUPC':
