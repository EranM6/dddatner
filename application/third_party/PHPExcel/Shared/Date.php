...
class PHPExcel_Shared_Date
{
    ...
    /**
     * Set the ExcelFile calendar (Windows 1900 or Mac 1904)
     *
     * @param     integer    $baseDate           ExcelFile base date (1900 or 1904)
    ...
    /**
     * Return the ExcelFile calendar (Windows 1900 or Mac 1904)
     *
     * @return     integer    ExcelFile base date (1900 or 1904)
     */
    ...
    /**
     *    Convert a date from ExcelFile to PHP
     *
     *    @param        integer        $dateValue            ExcelFile date/time value
    ...
    /**
     * Convert a date from ExcelFile to a PHP Date/Time object
     *
     * @param    integer        $dateValue        ExcelFile date/time value
    ...
    /**
     *    Convert a date from PHP to ExcelFile
     *
     *    @param    mixed        $dateValue            PHP serialized date/time or date object
     *    @param    boolean        $adjustToTimezone    Flag indicating whether $dateValue should be treated as
     *                                                    a UST timestamp, or adjusted to UST
     *    @param    string         $timezone            The timezone for finding the adjustment from UST
     *    @return    mixed        ExcelFile date/time value
     ...
     * @return   integer    ExcelFile date/time value
     */
    public static function FormattedPHPToExcel($year, $month, $day, $hours = 0, $minutes = 0, $seconds = 0)
    {
        if (self::$excelBaseDate == self::CALENDAR_WINDOWS_1900) {
            //
            //    Fudge factor for the erroneous fact that the year 1900 is treated as a Leap Year in MS ExcelFile
        ...
        //    Calculate the Julian Date, then subtract the ExcelFile base date (JD 2415020 = 31-Dec-1899 Giving ExcelFile Date of 0)
    ...
    /**
     * Convert a date/time string to ExcelFile time
     *
     * @param    string    $dateValue        Examples: '2009-12-31', '2009-12-31 15:59', '2009-12-31 15:59:10'
     * @return    float|FALSE        ExcelFile date/time serial value
     */
