...
abstract class PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
     ...
     *    immediately available to MS ExcelFile or other office spreadsheet viewer when opening the file
     *
     * @var boolean
     */
     ...
     *        so that the pre-calculated values are immediately available to MS ExcelFile or other office spreadsheet
     *        viewer when opening the file
     *     If false, then formulae are not calculated on save. This is faster for saving in PHPExcel, but slower
     *        when opening the resulting file in MS ExcelFile, because ExcelFile has to recalculate the formulae itself
     *
     * @return boolean
     */
