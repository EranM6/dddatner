...
// *  License Information:
// *
// *    Spreadsheet_Excel_Writer:  A library for generating ExcelFile Spreadsheets
...
//            if ($row + 1 > 65536 or $column + 1 > 256) {
     ...
     * always fixed range
     * See section 2.5.14 in OpenOffice.org's Documentation of the Microsoft ExcelFile File Format
     *
     ...
     * correspond to ExcelFile's defaults.
     *
     * @param bool $visible
     ...
     * An integer can be written as a double. ExcelFile will display an
     ...
     * NOTE: there is an ExcelFile 5 defined limit of 255 characters.
     * $format is optional.
     * Returns  0 : normal termination
     *         -2 : row or column out of range
     ...
     *
     * Note: ExcelFile writes some relative links with the $dir_long string. We ignore
    ...
    private function writeRow($row, $height, $xfIndex, $hidden = false, $level = 0)
    {
        ...
        $irwMac      = 0x0000;               // Used by ExcelFile to optimise loading
    ...
    /**
     * Writes ExcelFile DIMENSIONS to define the area in which there is data.
     */
     ...
     *
     * Note: The SDK says the record length is 0x0B but ExcelFile writes a 0x0C
     * length record.
     *
     * @param array $col_array This is the only parameter received and is composed of the following:
     *                0 => First formatted column,
     *                1 => Last formatted column,
     *                2 => Col width (8.43 is ExcelFile default),
     ...
     *
     * Openoffice.org's Documentaion of the Microsoft ExcelFile File Format uses term RANGEPROTECTION for these records
     * Microsoft Office ExcelFile 97-2007 Binary File Format Specification uses term FEAT for these records
     */
     ...
     *
     * ExcelFile only stores references to external sheets that are used in formulas.
    ...
    /**
     * Writes the ExcelFile BIFF EXTERNSHEET record. These references are used by
    ...
    /**
     * Writes the ExcelFile BIFF PANE record.
     * The panes can either be frozen or thawed (unfrozen).
     * Frozen panes are specified in terms of an integer number of rows and columns.
     * Thawed panes are specified in terms of ExcelFile's units for rows and columns.
     */
    private function writePanes()
    {
        ...
        if ($this->phpSheet->getFreezePane()) {
            ...
            // Convert ExcelFile's row and column units to the internal units.
     ...
     * where ExcelFile outline symbols are displayed. The visibility of the gutters is
    ...
    private function writeBreaks()
    {
        ...
        if (!empty($vbreaks)) {
            // 1000 vertical pagebreaks appears to be an internal ExcelFile 5 limit.
            // It is slightly higher in ExcelFile 97/200, approx. 1026
    ...
    public function positionImage($col_start, $row_start, $x1, $y1, $width, $height)
    {
        ...
        // Convert the pixel values to the percentage value expected by ExcelFile
     ...
     * to support other ExcelFile objects.
     *
                ...
                if ($spTypes[$i] == 0x00C9) {
                    ...
                    $objData .=
                        pack(
                            ...
                            $i, // object id number, ExcelFile seems to use 1-based index, local for the sheet
