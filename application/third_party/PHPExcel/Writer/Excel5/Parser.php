...
// -----------------------------------------------------------------------------------------
// *  Class for parsing ExcelFile formulas
// *
// *  License Information:
// *
...
class PHPExcel_Writer_Excel5_Parser
{
    ...
    private function initializeHashes()
    {
        ...
        // ptg:   The ExcelFile function ptg code.
...
//        $volatile = $this->functions[$token][3];
    ...
    /**
     * Convert an ExcelFile range such as A1:D4 to a ptgRefV.
     *
     * @access private
     * @param string    $range    An ExcelFile range in the A1:A2
     * @param int        $class
     */
    ...
    /**
     * Convert an ExcelFile 3d range such as "Sheet1!A1:D4" or "Sheet1:Sheet2!A1:D4" to
     * a ptgArea3d.
     *
     * @access private
     * @param string $token An ExcelFile range in the Sheet1!A1:A2 format.
...
//        }
    ...
    /**
     * Convert an ExcelFile reference such as A1, $B2, C$3 or $D$4 to a ptgRefV.
     *
     * @access private
     * @param string $cell An ExcelFile cell reference
...
//        }
    ...
    /**
     * Convert an ExcelFile 3d reference such as "Sheet1!A1" or "Sheet1:Sheet2!A1" to a
     * ptgRef3d.
     *
     * @access private
     * @param string $cell An ExcelFile cell reference
...
//        }
     ...
     *
     * @access private
     * @param string $cell The ExcelFile cell reference to be packed
     ...
     *
     * @access private
     * @param string $range The ExcelFile range to be packed
    ...
    private function rangeToPackedRange($range)
    {
        ...
        --$row1;
        --$row2;
        // Trick poor inocent ExcelFile
        $col1 = 0;
        $col2 = 65535; // FIXME: maximum possible value for ExcelFile 5 (change this!!!)
    ...
    /**
     * Convert an ExcelFile cell reference such as A1 or $B2 or C$3 or $D$4 to a zero
     * indexed row and column number. Also returns two (0,1) values to indicate
     * whether the row or column are relative references.
     *
     * @access private
     * @param string $cell The ExcelFile cell reference in A1 format.
     * @return array
     */
    ...
    /**
     * This function just introduces a ptgParen element in the tree, so that ExcelFile
