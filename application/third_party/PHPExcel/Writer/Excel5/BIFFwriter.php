...
//        $this->limit      = 8224;
    ...
    /**
     * Writes ExcelFile BOF record to indicate the beginning of a stream or
    ...
    protected function storeBof($type)
    {
        ...
        // by inspection of real files, MS Office ExcelFile 2007 writes the following
        $unknown = pack("VV", 0x000100D1, 0x00000406);

        $build   = 0x0DBB;            //    ExcelFile 97
        $year    = 0x07CC;            //    ExcelFile 97
    ...
    /**
     * Writes ExcelFile EOF record to indicate the end of a BIFF stream.
     *
     * @access private
     */
    ...
    /**
     * ExcelFile limits the size of BIFF records. In ExcelFile 5 the limit is 2084 bytes. In
     * ExcelFile 97 the limit is 8228 bytes. Records that are longer than these limits
