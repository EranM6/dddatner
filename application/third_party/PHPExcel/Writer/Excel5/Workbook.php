...
class PHPExcel_Writer_Excel5_Workbook extends PHPExcel_Writer_Excel5_BIFFwriter
{
    ...
    /**
     * Sets the colour palette to the ExcelFile 97+ default.
     *
     * @access private
     */
    ...
    /**
     * Store the ExcelFile FONT records.
     */
    ...
    /**
     * Write ExcelFile BIFF WINDOW1 record.
     */
    ...
    /**
     * Writes ExcelFile BIFF BOUNDSHEET record.
     *
    ...
    /**
     * Write ExcelFile BIFF STYLE records.
     */
    ...
    /**
     * Writes ExcelFile FORMAT record for non "built-in" numerical formats.
     *
     ...
     *
     * ExcelFile only stores references to external sheets that are used in NAME.
    ...
    private function writeRecalcId()
    {
        ...
        // by inspection of real ExcelFile files, MS Office ExcelFile 2007 writes this
     ...
     * supported).
     *
     * The ExcelFile documentation says that the SST record should be followed by an
