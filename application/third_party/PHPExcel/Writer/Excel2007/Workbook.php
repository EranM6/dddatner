...
class PHPExcel_Writer_Excel2007_Workbook extends PHPExcel_Writer_Excel2007_WriterPart
{
    ...
    private function writeCalcPr(PHPExcel_Shared_XMLWriter $objWriter = null, $recalcRequired = true)
    {
        ...
        //    Set the calcid to a higher value than ExcelFile itself will use, otherwise ExcelFile will always recalc
        //  If MS ExcelFile does do a recalc, then users opening a file in MS ExcelFile will be prompted to save on exit
