...
class PHPExcel_Writer_CSV extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    /**
     * Whether to write a fully ExcelFile compatible CSV file.
     *
     * @var boolean
     */
    ...
    /**
     * Get whether the file should be saved with full ExcelFile Compatibility
     *
     * @return boolean
     */
    ...
    /**
     * Set whether the file should be saved with full ExcelFile Compatibility
     *
     * @param    boolean    $pValue        Set the file to be written as a fully ExcelFile compatible csv file
