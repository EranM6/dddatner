...
class PHPExcel_Writer_HTML extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    /**
     * ExcelFile cells that should not be written as HTML cells
     *
     * @var array
     */
    ...
    /**
     * ExcelFile cells that are upper-left corner in a cell merge
     *
     * @var array
     */
    ...
    /**
     * ExcelFile rows that should not be written as HTML rows
     *
     * @var array
     */
...
//        $css = $this->mapBorderStyle($pStyle->getBorderStyle()) . ' #' . $pStyle->getColor()->getRGB();
    ...
    /**
     * Calculate information about HTML colspan and rowspan which is not always the same as ExcelFile's
     */
    private function calculateSpans()
    {
        ...
        foreach ($sheetIndexes as $sheetIndex) {
            ...
            // loop through all ExcelFile merged cells
                    ...
                    while ($c++ < $lc) {
                        if (!($c == $fc && $r == $fr)) {
                            ...
                            $this->isBaseCell[$sheetIndex][$r][$c] = array(
                                'xlrowspan' => $lr - $fr + 1, // ExcelFile rowspan
                                'rowspan'   => $lr - $fr + 1, // HTML rowspan, value may change
                                'xlcolspan' => $lc - $fc + 1, // ExcelFile colspan
