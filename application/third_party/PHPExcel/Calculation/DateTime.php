...
class PHPExcel_Calculation_DateTime
{
     ...
     * @return    mixed    ExcelFile date/time serial value, or string if error
     */
     ...
     * open the worksheet.
     *
     * NOTE: When used in a Cell Formula, MS ExcelFile changes the cell format so that it matches the date
     ...
     * @return    mixed    ExcelFile date/time serial value, PHP date/time serial value or PHP date/time object,
     ...
     *        DATE(year,month,day)
     *
     * PHPExcel is a lot more forgiving than MS ExcelFile when passing non numeric values to this function.
     ...
     *                                ExcelFile interprets the year argument according to the configured
     *                                date system: 1900 or 1904.
     *                                If year is between 0 (zero) and 1899 (inclusive), ExcelFile adds that
     *                                value to 1900 to calculate the year. For example, DATE(108,1,2)
     *                                returns January 2, 2008 (1900+108).
     *                                If year is between 1900 and 9999 (inclusive), ExcelFile uses that
     *                                value as the year. For example, DATE(2008,1,2) returns January 2,
     *                                2008.
     *                                If year is less than 0 or is 10000 or greater, ExcelFile returns the
     *                                #NUM! error value.
     ...
     *
     * NOTE: When used in a Cell Formula, MS ExcelFile changes the cell format so that it matches the time
     * format of your regional settings. PHPExcel does not change cell formatting in this way.
     *
     * ExcelFile Function:
     ...
     * Use DATEVALUE to convert a date represented by a text string to an ExcelFile or PHP date/time stamp
     * value.
     *
     * NOTE: When used in a Cell Formula, MS ExcelFile changes the cell format so that it matches the date
     * format of your regional settings. PHPExcel does not change cell formatting in this way.
     ...
     * @access    public
     * @category Date/Time Functions
     * @param    string    $dateValue        Text that represents a date in a Microsoft ExcelFile date format.
     *                                    For example, "1/30/2008" or "30-Jan-2008" are text strings within
     *                                    quotation marks that represent dates. Using the default date
     *                                    system in ExcelFile for Windows, date_text must represent a date from
     *                                    January 1, 1900, to December 31, 9999. Using the default date
     *                                    system in ExcelFile for the Macintosh, date_text must represent a date
    ...
    public static function DATEVALUE($dateValue = 1)
    {
        ...
        //    Strip any ordinals because they're allowed in ExcelFile (English only)
     ...
     * Use TIMEVALUE to convert a time represented by a text string to an ExcelFile or PHP date/time stamp
     * value.
     *
     * NOTE: When used in a Cell Formula, MS ExcelFile changes the cell format so that it matches the time
     * format of your regional settings. PHPExcel does not change cell formatting in this way.
     ...
     *                                    ExcelFile time formats; for example, "6:45 PM" and "18:45" text strings
     ...
     * DATEDIF
     *
     * @param    mixed    $startDate        ExcelFile date serial value, PHP date/time stamp, PHP DateTime object
     *                                    or a standard date string
     * @param    mixed    $endDate        ExcelFile date serial value, PHP date/time stamp, PHP DateTime object
     *                                    or a standard date string
     * @param    string    $unit
     ...
     * @access    public
     * @category Date/Time Functions
     * @param    mixed        $startDate        ExcelFile date serial value (float), PHP date timestamp (integer),
     *                                        PHP DateTime object, or a standard date string
     * @param    mixed        $endDate        ExcelFile date serial value (float), PHP date timestamp (integer),
     *                                        PHP DateTime object, or a standard date string
     ...
     * @param    mixed            $endDate        ExcelFile date serial value (float), PHP date timestamp (integer),
     *                                            PHP DateTime object, or a standard date string
     * @param    mixed            $holidays,...    Optional series of ExcelFile date serial value (float), PHP date
     ...
     *        DAY(dateValue)
     *
     * @param    mixed    $dateValue        ExcelFile date serial value (float), PHP date timestamp (integer),
     *                                    PHP DateTime object, or a standard date string
    ...
    public static function DAYOFWEEK($dateValue = 1, $style = 1)
    {
        ...
        if (PHPExcel_Calculation_Functions::getCompatibilityMode() == PHPExcel_Calculation_Functions::COMPATIBILITY_EXCEL) {
            //    Test for ExcelFile's 1900 leap year, and introduce the error as required
     ...
     *        HOUR(timeValue)
     *
     * @param    mixed    $timeValue        ExcelFile date serial value (float), PHP date timestamp (integer),
