...
class PHPExcel_Calculation_Engineering
{
     ...
     *
     *    Note: In ExcelFile 2007 or earlier, if you input a negative value for the upper or lower bound arguments,
     *            the function would return a #NUM! error. However, in ExcelFile 2010, the function algorithm was
     *            improved, so that it can now calculate the function for both positive and negative ranges.
     *            PHPExcel follows ExcelFile 2010 behaviour, and accepts nagative arguments.
     *
     *    ExcelFile Function:
     *        ERF(lower[,upper])
     *
     ...
     *
     *    Note: In ExcelFile 2007 or earlier, if you input a negative value for the lower bound argument,
     *        the function would return a #NUM! error. However, in ExcelFile 2010, the function algorithm was
