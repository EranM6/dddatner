...
class PHPExcel_Calculation_LookupRef
{
     ...
     *
     * NOTE - INDIRECT() does not yet support the optional a1 parameter introduced in ExcelFile 2010
     *
     * @param    cellAddress        $cellAddress    The cell address of the current cell (containing this formula)
     * @param    PHPExcel_Cell    $pCell            The current cell (containing this formula)
     * @return    mixed            The cells referenced by cellAddress
     *
     * @todo    Support for the optional a1 parameter introduced in ExcelFile 2010
     *
     */
     ...
     * @return    array
     *
     * Unlike the ExcelFile TRANSPOSE function, which will only work on a single row or column, this function will transpose a full matrix.
     */
