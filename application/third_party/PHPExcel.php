...
class PHPExcel
{
    ...
    */
    ...
    /**
    * ribbonXMLData : null if workbook is'nt ExcelFile 2007 or not contain a customized UI
    *
    * @var null|string
    */
    ...
    /**
    * ribbonBinObjects : null if workbook is'nt ExcelFile 2007 or not contain embedded objects (picture(s)) for Ribbon Elements
